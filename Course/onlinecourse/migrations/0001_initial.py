    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_text', models.CharField(default='answer', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.enrollment')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.AddField(
            model_name='choice',
            name='question',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='choices', to='onlinecourse.question'),
        ),
    ]
